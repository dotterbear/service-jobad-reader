...
public class ApiResponseAspect {
	...
	@Around(value = "@within(com.dotterbear.jobad.reader.rest.api.ApiEndpoint) || @annotation(com.dotterbear.jobad.reader.rest.api.ApiEndpoint)")
	public Object aroundApiEndpoint(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			log.warn("unable to set default OK code, message to response, joinPoint.getSignature(): {}", joinPoint.getSignature(), e);
		}
		return obj;
	}
